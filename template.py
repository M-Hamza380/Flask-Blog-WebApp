...
list_of_files = [
    ...
    f"src/{Project_Name}/users/posts/__init__.py",
    f"src/{Project_Name}/users/posts/forms.py",
    f"src/{Project_Name}/users/posts/routes.py",
    f"src/{Project_Name}/users/admin/__init__.py",
    f"src/{Project_Name}/users/admin/forms.py",
